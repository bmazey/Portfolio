...
/**
 * The driver class that runs the Java to C++ Translator.
 */
public class Translator extends Tool
{
  ...
  /**
   * Gets the copyright of the translator
   *
   * @return The copyright of the translator
   */
  ...
  public void init() {
    ...
    runtime.
      ...
      bool("translateToCPP", "translateToCPP", false, "Print out all C++ source to make a C++ program that works like the corresponding Java program.");
  }
  ...
  public File locate(String name) throws IOException {
    ...
    {
      mainClass = file.getName(); // Store the name of the main class
  ...
  /**
   * Process the given Node as specified in the command line arguments
   *
   * @param The node
   */
  public void process(Node node) {
    ...
    {
      new CPPPrinter(new Printer(System.out), mainClass).dispatch(node);
    }
